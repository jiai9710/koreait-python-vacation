...
def hello_name(name):
    ...
    # print(f"{his_name}")  일반변수는 함수 내에서 사용가능

# print(name) -> name은 함수 안에서만 생존 따라서 에러
hello_name("홍길동")
hello_name("박길동")
...
other_pn = "991122-3344556"
result1 = get_gender(other_pn)
...
# 매개변수에 기본값을 지정할 수 있다
def print_info(name, age, nationality):
    print(f"이름 : {name}, 나이 : {age}, 국적 : {nationality}")

# 기본값 설정이 되면, 호출 시 매개변수 생략해도
# 기본값 사용됨.
print_info("홍길동", 30)
